...
namespace Template.Utilities
{
    public class images
    {
        public async Task<string> CreateImageAsync(SocketGuildUser user)
        {
            ...
            var background = await FetchImageAsync("https://i.ytimg.com/vi/Iu90z9Akxgk/mqdefault.jpg");
            ...
            banner = DrawTextToImage(banner, $"{user.Username}", $" ");
        ...
        private async Task<Image> FetchImageAsync(string url)
        {
            ...
            {
                var backupResponse = await client.GetAsync("https://i.ytimg.com/vi/Iu90z9Akxgk/mqdefault.jpg");
